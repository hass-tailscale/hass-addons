...
For more information, see the add-on documentation and the Tailscale [website](https://tailscale.com).
...
3. If the app still does not start, raise an [issue](https://github.com/hass-tailscale/hass-addons/issues).
