...
3. Enter `https://github.com/hass-tailscale/hass-addons` as the new repository and click Add.
...
See [Subnet routers](https://tailscale.com/docs/features/subnet-routers) for more information.
...
See [Exit nodes (route all traffic)](https://tailscale.com/docs/features/exit-nodes) for more information.
...
If enabled, you will need to have preconfigured the specified IP as an exit node. See the [Exit nodes (route all traffic)](https://tailscale.com/docs/features/exit-nodes) for more information.
...
See [Subnets](https://tailscale.com/docs/features/subnets) for more information.
...
See [Userspace networking mode (for containers)](https://tailscale.com/docs/concepts/userspace-networking) for more information.
...
See [Group devices with tags](https://tailscale.com/docs/features/tags) for more information.
...
See [Enabling HTTPS](https://tailscale.com/docs/how-to/set-up-https-certificates) for more information.

### Option: `ssh`

This option (if set) indicates that Tailscale is managing SSH connections originating from the Tailscale network to this host. This allows you to connect to the addon using SSH. Thanks to [Tailscale SSH](https://tailscale.com/docs/features/tailscale-ssh), you can even connect to the instance directly in the browser.

You can get shell access to this add-on, and from there, you can connect to the other hosts on your network.

See [Tailscale SSH](https://tailscale.com/docs/features/tailscale-ssh) for more information.
...
See [Set up an app connector](https://tailscale.com/docs/features/app-connectors/how-to/setup) for more information on how to utilize this feature.
