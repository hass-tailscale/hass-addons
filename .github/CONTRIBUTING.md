# Contributing to hass-tailscale

First time contributing to hass-tailscale? Read our [Code of Conduct](https://github.com/hass-tailscale/hass-addons/blob/main/.github/CODE_OF_CONDUCT.md#code-of-conduct)

### Discuss, ask questions about or disagree with changes in hass-tailscale

- [hass-tailscale/discussions](https://github.com/orgs/hass-tailscale/discussions) is the place for community discussions around hass-tailscale.
- Our issues and pull requests are for maintainers and contributors to discuss work to be done, not users or contributors asking questions about hass-tailscale usage or disagreeing with changes already made.

### Report a bug

- Ideally, open a pull request to fix it, describing both your problem and your proposed solution.
- If not, open an issue on the relevant repository, but do not open both an issue and a pull request.
